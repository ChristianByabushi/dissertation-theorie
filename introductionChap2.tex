...
A part from cross-validation, we have the measure of metrics as one of highly technique used to estimate the model accuracy. However, the metrics depends on tasks performed by the model: 

For classification metrics \cite{raschka2018model} there are:
\begin{itemize}
	\item Accuracy 
	\item Precision
	\item Recall 
