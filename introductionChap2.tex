...
In the same way, functions \textbf{read\_json, read\_html}  are also respectively computing the JSON and HTML data.\\
...
\subsubsection{Data Visulation With Matplotlib and Seaborn}
