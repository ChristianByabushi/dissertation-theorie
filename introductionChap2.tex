...
\section{Summary concerning the tools and frameworks}
The completion of this project necessitated the utilization of various dependencies, tools, frameworks. These resources were instrumental in realizing the project's objectives. Notably, they were categorized into two main areas: those integral to the core functionality and others relevant to the user side, distinguishing the back-end from the front-end. Moreover, the project involved tools for data analysis and predictive modeling. The structure of these tools is presented in the  table \ref{tableStructuring}  for clarity.
  \\
\begin{table}
\begin{tabular}{|p{4.1cm}|p{4cm}|p{6cm}|}
	\cline{2-3}
    \multicolumn{1}{c|}{} & Tools   & Utilities  \\
	\hline
\multirow{11}{4cm}{Data analysis and Machine Learning libraries}	& Numpy & Scientific computing library   \\ 
	\cline{2-3} 
	& Panda  & Data manipulation and
	analysis library  \\ 
	\cline{2-3} 
	& Matplotlib  & Python library used for 2D and 3D data visualization   \\ 
	\cline{2-3}  
	& Seaborn & Seaborn is another Python library for statistical data visualization, built on matplotlib.\\
	\cline{2-3} 
		& Scickit learn & Machine learning machine learning library \\
	\hline
	\multirow{5}{4cm}{Programming Languages (Front-end and Back-end)}&   Django Python & Python framework for developing web applications and APIs \\ 
	 \cline{2-3}
