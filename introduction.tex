	...
	\begin{center}
		...
		{\large {\huge {\LARGE 	FACULTY OF SCIENCES  \textsf{}}}}\\ 
			...
			\begin{minipage}[c]{15cm}
				\begin{center}
					\LARGE{\textbf{\textcolor{black}{Development of a messaging application for communication and detection of spam on a mobile operator, case study of on Airtel, Vodacom and Orange.}}}
				\end{center}
		\end{minipage}
	\end{center}
